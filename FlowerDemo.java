...
public class FlowerDemo {
	private static void displayFlower(String cont) {
			...
			case "asia": System.out.println("Asia\t\t| India   \t| Lotus\t          |");
						 ...
						 break;
		  case "europe":
			  			 System.out.println("Europe\t\t| Germany\t| Corn Flower\t  |");
		  				 System.out.println("\t\t| France\t| Lily\t          |");
		  			     System.out.println("\t\t| Greece\t| ACANTHUS MOLLIS |");
		  			     break;
		  case "africa":
			  			 System.out.println("Africa\t\t| Egypt  \t|  Blue Lotus\t  |");
		  				 System.out.println("\t\t| Nigeria\t| Yellow Trumpet  |");
		  				 System.out.println("\t\t| Kenya  \t| Orchid\t  |");
		  				 break;
	  case "antarctica":
		  				 System.out.println("Antarctica\t| Antarctica\t|Colobanthus quitensis|");
	    				 break;
		  				
    case "northamerica":
    					 System.out.println("North America\t| USA\t\t| Rose\t\t  |");
	...
	public static void main(String[] args) {
		...
		System.out.println("----------------|---------------|-----------------| ");
		displayFlower(cont.toLowerCase());
	}
}
